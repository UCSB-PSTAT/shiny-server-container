                ...
                stages {
                    stage('Build Test Deploy') {
                        ...
                        stages{
                            ...
                            stage('Test') {
                                steps {
                                    sh 'podman run -it --rm localhost/$IMAGE_NAME R -c "library(shiny); library(shinythemes); library(maps); library(mapproj); library(leaflet); library(rgdal); library(dplyr); library(sf); library(sp); library(flexdashboard); library(plotly); library(stringr)"'
